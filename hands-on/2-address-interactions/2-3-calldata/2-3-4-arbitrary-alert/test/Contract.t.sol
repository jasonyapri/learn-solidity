...
contract ContractTest is Test {
    ...
    function testAlert1() public {
        ...
        assertEq(
            enemies,
            5,
            "it should have let the hero know theres 5 enemies"
        );
        assertEq(
            armed,
            true,
            "it should have let the hero know the enemies are armed"
        );
    }
    ...
    function testAlert2() public {
        ...
        assertEq(
            enemies,
            2,
            "it should have let the hero know theres 2 enemies"
        );
        assertEq(
            armed,
            false,
            "it should have let the hero know the enemies are not armed"
        );
    }
}
